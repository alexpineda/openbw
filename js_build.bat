...
set FAST=-O3 -s DISABLE_EXCEPTION_CATCHING=0 -g0 -s ASSERTIONS=0 --closure 1
set OPTIMIZATION=%SLOW%

set WEBGL=-s MAX_WEBGL_VERSION=2 -s MIN_WEBGL_VERSION=2
set PTHREAD=-pthread -s PROXY_TO_PTHREAD -s PTHREAD_POOL_SIZE=4 ALLOW_BLOCKING_ON_MAIN_THREAD=0
